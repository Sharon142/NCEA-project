...
"luni-solar and horary tables", "nikola tesla", "fought to study medicine", "false"];//second set of correct answers
const correct = [answerList.concat(answers)];//combining both sets of answers
